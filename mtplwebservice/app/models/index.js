...
const usersSchema=require("./userModel/userModel.js")
const provincesSchema = require("./provincesModel/provincesModel")
const mtpCalculatorSchema = require("./mtplModel/mtplCalculator")
const purchasepolicySchema = require("./mtplModel/purchasePolicy")
const db = {};
